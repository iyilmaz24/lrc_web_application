        ...
        <NavigationMenu.Item>
          ...
          <NavigationMenu.Content className="NavigationMenuContent">
            <ul className="List one">
              ...
              <ListItem href="/dashboard/slug1" title="2022 General Election">
                Dashboards for the 2022 General Election
              </ListItem>
              <ListItem href="/dashboard/slug2" title="2022 Primary Election">
        ...
        <NavigationMenu.Item>
          ...
          <NavigationMenu.Content className="NavigationMenuContent">
            <ul className="List two">
              <ListItem title="Primary Ballots with Signatures" href="/ballots">
                {" "}
              </ListItem>
              <ListItem
              ...
              <ListItem title="Primary Ballots with No Votes" href="/ballots">
                {" "}
              </ListItem>
              <ListItem
